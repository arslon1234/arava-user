...
const Footer = () => {
  return (
    <footer className="bg-[#F6F6FB] pt-10 pb-[92px] md:pb-8">
      <Container>
        ...
        <div className="flex flex-col sm:flex-row gap-5 items-center justify-between pt-10">
          ...
          <div className="flex items-center gap-10 sm:gap-6">
            <Link href="/">
              <LiaInstagram className="text-[35px] lg:hover:scale-110 duration-200 text-gray-500" />
            </Link>
            <Link href="/">
              <LiaTelegram className="text-[35px] lg:hover:scale-110 duration-200 text-gray-500" />
            </Link>
            <Link href="/">
              <LiaFacebook className="text-[35px] lg:hover:scale-110 duration-200 text-gray-500" />
            </Link>
          </div>
        </div>
      </Container>
