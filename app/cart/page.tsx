    ...
    <section className="min-h-screen pt-[100px] lg:pt-[130px]">
      <Container>
        <div className="pb-[165px]">
          <div className="pb-4 flex items-center justify-between">
            <div>
              <p className="text-[20px] font-semibold">Savat</p>
            ...
            <button className="flex items-center gap-1 active:bg-gray-200 duration-150 rounded-md px-2 py-1 opacity-70">
              <FaTrashAlt />
              <p className="text-[14px]">Tozalash</p>
            </button>
          </div>
          <div className="px-1">
            {cartItems.map((item) => (
              ...
              >
                ...
                <div>
                  <p className="text-[17px]">{formatNumber(item.price * item.quantity)} so`m</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="w-full pt-3 pb-[70px] px-4 border-t border-gray-400 fixed bottom-0 bg-white">
        <div className="flex items-center gap-3">
          ...
          <p>Yetkazib berish {formatNumber(5000)} so`m</p>
        </div>
