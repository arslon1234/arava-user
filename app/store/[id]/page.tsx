            ...
            <div>
              {loading ? (
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                  <div className="xl:w-[205px] h-[300px] md:h-[340px]">
                    <Skeleton
          ...
          {loading ? (
            ...
            <div className="bg-[#fff] w-[28%] hidden md:block h-[600px] overflow-hidden border border-gray-300 rounded-3xl sticky top-[130px]">
              ...
              <div className="w-full p-3 border sticky bottom-0 bg-white">
                ...
                <button className="bg-mainColor hover:bg-[#23b574] duration-200 w-full flex flex-col lg:flex-row items-center rounded-lg justify-between px-4 xl:px-5 py-2 xl:py-3 text-white mt-3 font-medium">
